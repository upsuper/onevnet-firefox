...
function FindProxyForURL(url, host){
    ...
    var D = 'DIRECT';
    //ServerList
    var P = 'HTTPS h-d.vnet.one:443;HTTPS h-d.vnet.one:465;HTTPS h-d.vnet.one:311;HTTPS h-d.vnet.one:321;HTTPS h-d.vnet.one:331;PROXY h-d.vnet.one:310;PROXY h-d.vnet.one:143;PROXY h-d.vnet.one:320;PROXY h-d.vnet.one:330;PROXY h-d.vnet.one:2048;';
