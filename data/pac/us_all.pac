...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        var P = 'HTTPS node-us.vnet.one:443;HTTPS node-us.vnet.one:465;HTTPS node-us.vnet.one:311;HTTPS node-us.vnet.one:321;HTTPS node-us.vnet.one:331;PROXY node-us.vnet.one:80;PROXY node-us.vnet.one:310;PROXY node-us.vnet.one:143;PROXY node-us.vnet.one:320;PROXY node-us.vnet.one:330;';
    }else{
        var P = 'PROXY node-us.vnet.one:80;PROXY node-us.vnet.one:310;PROXY node-us.vnet.one:143;PROXY node-us.vnet.one:320;PROXY node-us.vnet.one:330;HTTPS node-us.vnet.one:443;HTTPS node-us.vnet.one:465;HTTPS node-us.vnet.one:311;HTTPS node-us.vnet.one:321;HTTPS node-us.vnet.one:331;';
    }
