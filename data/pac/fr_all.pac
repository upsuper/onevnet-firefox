...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        var P = 'HTTPS node-fr.vnet.one:443;HTTPS node-fr.vnet.one:465;HTTPS node-fr.vnet.one:311;HTTPS node-fr.vnet.one:321;HTTPS node-fr.vnet.one:331;PROXY node-fr.vnet.one:80;PROXY node-fr.vnet.one:310;PROXY node-fr.vnet.one:143;PROXY node-fr.vnet.one:320;PROXY node-fr.vnet.one:330;';
    }else{
        var P = 'PROXY node-fr.vnet.one:80;PROXY node-fr.vnet.one:310;PROXY node-fr.vnet.one:143;PROXY node-fr.vnet.one:320;PROXY node-fr.vnet.one:330;HTTPS node-fr.vnet.one:443;HTTPS node-fr.vnet.one:465;HTTPS node-fr.vnet.one:311;HTTPS node-fr.vnet.one:321;HTTPS node-fr.vnet.one:331;';
    }
