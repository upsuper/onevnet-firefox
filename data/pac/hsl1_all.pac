...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        ...
        var P = 'PROXY hsline-1.vnet.one:80;PROXY hsline-1.vnet.one:310;PROXY hsline-1.vnet.one:143;PROXY hsline-1.vnet.one:320;PROXY hsline-1.vnet.one:330;PROXY hsline-1.vnet.one:2048;HTTPS hsline-1.vnet.one:443;HTTPS hsline-1.vnet.one:465;HTTPS hsline-1.vnet.one:311;HTTPS hsline-1.vnet.one:321;HTTPS hsline-1.vnet.one:331;';
    }
