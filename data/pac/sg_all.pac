...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        var P = 'HTTPS node-sg.vnet.one:443;HTTPS node-sg.vnet.one:465;HTTPS node-sg.vnet.one:311;HTTPS node-sg.vnet.one:321;HTTPS node-sg.vnet.one:331;PROXY node-sg.vnet.one:80;PROXY node-sg.vnet.one:310;PROXY node-sg.vnet.one:143;PROXY node-sg.vnet.one:320;PROXY node-sg.vnet.one:330;';
    }else{
        var P = 'PROXY node-sg.vnet.one:80;PROXY node-sg.vnet.one:310;PROXY node-sg.vnet.one:143;PROXY node-sg.vnet.one:320;PROXY node-sg.vnet.one:330;HTTPS node-sg.vnet.one:443;HTTPS node-sg.vnet.one:465;HTTPS node-sg.vnet.one:311;HTTPS node-sg.vnet.one:321;HTTPS node-sg.vnet.one:331;';
    }
