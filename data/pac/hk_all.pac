...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        var P = 'HTTPS node-hk.vnet.one:443;HTTPS node-hk.vnet.one:465;HTTPS node-hk.vnet.one:311;HTTPS node-hk.vnet.one:321;HTTPS node-hk.vnet.one:331;PROXY node-hk.vnet.one:80;PROXY node-hk.vnet.one:310;PROXY node-hk.vnet.one:143;PROXY node-hk.vnet.one:320;PROXY node-hk.vnet.one:330;';
    }else{
        var P = 'PROXY node-hk.vnet.one:80;PROXY node-hk.vnet.one:310;PROXY node-hk.vnet.one:143;PROXY node-hk.vnet.one:320;PROXY node-hk.vnet.one:330;HTTPS node-hk.vnet.one:443;HTTPS node-hk.vnet.one:465;HTTPS node-hk.vnet.one:311;HTTPS node-hk.vnet.one:321;HTTPS node-hk.vnet.one:331;';
    }
