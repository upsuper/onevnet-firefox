...
function FindProxyForURL(url, host){
    ...
    if(isHTTPS(url)===false){
        var P = 'HTTPS node-jp.vnet.one:443;HTTPS node-jp.vnet.one:465;HTTPS node-jp.vnet.one:311;HTTPS node-jp.vnet.one:321;HTTPS node-jp.vnet.one:331;PROXY node-jp.vnet.one:80;PROXY node-jp.vnet.one:310;PROXY node-jp.vnet.one:143;PROXY node-jp.vnet.one:320;PROXY node-jp.vnet.one:330;';
    }else{
        var P = 'PROXY node-jp.vnet.one:80;PROXY node-jp.vnet.one:310;PROXY node-jp.vnet.one:143;PROXY node-jp.vnet.one:320;PROXY node-jp.vnet.one:330;HTTPS node-jp.vnet.one:443;HTTPS node-jp.vnet.one:465;HTTPS node-jp.vnet.one:311;HTTPS node-jp.vnet.one:321;HTTPS node-jp.vnet.one:331;';
    }
